...
export const sortGenerator = (
  ...
  const output = (key) => {
    const myToSorted = (sign) =>
      toSortedHelper(arr, ref, sign, keyGenerator, setSorted);
